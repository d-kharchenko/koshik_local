...
class PageController extends Controller
{
    ...
    public function orderfinishAction(Request $request)
    {
       /*$request = new Request(
        ...
        $it = 0;
        foreach ($products_cart_q as $curProduct) {
            $products_cart[$it] = array("id" => $cdurProduct->getid(), "name" => $curProduct->getName(), "description" => $curProduct->getdescription(), "price" => $curProduct->getprice(), "qty" => $products_array_idqty[$curProduct->getId()]);
    ...
    function getProductsByIdsAndGroupId($products_ids, $groupId){
     ...
     public function loginAction() {
        return $this->render('SushiSushiBundle:Page:login.html.twig');    
    }

    public function signupAction() {
        return $this->render('SushiSushiBundle:Page:signup.html.twig');    
    }

    public function userlogAction() {
        return $this->render('SushiSushiBundle:Page:userlog.html.twig');    
    }
    public function orderhistoryAction() {
        return $this->render('SushiSushiBundle:Page:orderhistory.html.twig');    
    }
